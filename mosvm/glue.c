...
void glue( const char* fragname, FILE* out, const char* outname ){
    mqo_word fragsize=copy( fragname, out, outname );
...
int main(int argc, char* argv[]){
    if( argc < 4 ){
        fprintf( stderr, "usage: glue stub frag0 frag1 ... result\n" );
        return 1;
    }
